...
DEFAULT_ACCOUNT_ID_MAP = {
    ...
    #   dart_OperatingIncomeLoss 없는 경우 ifrs-full_GrossProfit fallback
    #   (매출총이익=영업이익인 특수업종 대응 — 일반 제조업은 dart_OperatingIncomeLoss 사용)
    "dart_OperatingIncomeLoss":                       "operating_profit",  # 한국 DART 표준
    "ifrs-full_ProfitLossFromOperatingActivities":    "operating_profit",
    "ifrs-full_GrossProfit":                          "operating_profit",  # fallback (dart_OperatingIncomeLoss 없는 경우)
