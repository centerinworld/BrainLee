"""Production collector with a refreshed, date-pinned ETF universe."""
from __future__ import annotations

from pathlib import Path
from typing import Any

import etf_universe_sync
...
def collect_with_universe(
    ...
    universe_result = etf_universe_sync.sync_universe(conn, day)
    dated = etf_universe_sync.dated_universe(conn, day)
    conn.close()
