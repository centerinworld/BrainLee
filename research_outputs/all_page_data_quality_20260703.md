...
|시장지표|투자자별 매매|`investor_trading_daily`|ok|4513953|2018-04-23 ~ 2026-07-02|-|public_data_collector.py / KIS|-|
|시장지표|Kiwoom 투자자 수급|`kiwoom_investor_daily`|ok|4513953|2018-04-23 ~ 2026-07-02|-|Kiwoom ka10059|-|
...
|시장지표|Kiwoom 외국인 지분|`kiwoom_foreign_flow`|ok|155193|20260312 ~ 20260702|-|Kiwoom ka10008|-|
|시장지표|대차잔고 종목|`short_sell_daily`|ok_with_fallback|3784427|20200102 ~ 20260701|covered_by:short_rank_daily.lnb_bal<br>종목별 API가 잔고금액을 제공하지 않는 구간은 대차순위 금액 필드로 보완|collect_short_5years.py / public_data_collector.py|-|
|시장지표|대차순위|`short_rank_daily`|ok|3300779|20210104 ~ 20260701|-|collect_short_5years.py|-|
...
|컨센서스/종목|컨센서스|`consensus_targets`|unstable_or_needs_review|11264|2024-05-08 ~ 2026-07-02|duplicate_grain:21|collect_consensus|report_idx가 없는 한경 리포트는 자연키로 중복 판정|
|텐버거|텐버거 결과|`tenbagger_results`|ok|940|2026-06-06 10:20:15 ~ 2026-07-02 15:00:00|-|routes/tenbagger run|-|
