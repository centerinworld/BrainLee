...
- `price_history` / `repair_invalid_ohlcv_from_stock_price_daily`: 0 rows (backup: `data_quality_backup_price_history_ohlcv_20260626_221532`)
- `stock_price_daily` / `repair_invalid_ohlcv_from_price_history`: 0 rows (backup: `data_quality_backup_stock_price_daily_ohlcv_20260626_221532`)
- `price_history` / `backfill_trade_amount_close_times_volume`: 2,733 rows (backup: `data_quality_backup_price_history_trade_amount_20260626_221532`)
- `stock_universe` / `backfill_trading_value_close_times_volume`: 0 rows (backup: `data_quality_backup_stock_universe_trading_value_20260626_221532`)

## Before vs After

| Check | Before | After |
|---|---:|---:|
| `price_history_invalid_ohlcv_numeric` | 0 | 0 |
| `price_history_trade_amount_missing_repairable` | 2,733 | 0 |
| `price_history_invalid_repairable_from_stock_price_daily` | 0 | 0 |
| `stock_price_daily_invalid_ohlcv_numeric` | 0 | 0 |
| `stock_price_daily_invalid_repairable_from_price_history` | 0 | 0 |
| `stock_universe_invalid_ohlcv_numeric` | 0 | 0 |
...
| `kiwoom_investor_daily_invalid_market_fields` | 2,197,620 | 2,197,620 |
...
- Summary JSON: `/Applications/stock_dashboard/research_outputs/core_data_quality_20260624/20260626_221532/summary.json`
- Table row counts: `/Applications/stock_dashboard/research_outputs/core_data_quality_20260624/20260626_221532/after/table_row_counts.csv`
- Future-dated rows: `/Applications/stock_dashboard/research_outputs/core_data_quality_20260624/20260626_221532/after/future_dated_rows.csv`
- Bad stock-code rows: `/Applications/stock_dashboard/research_outputs/core_data_quality_20260624/20260626_221532/after/bad_stock_code_rows.csv`
