# 전체 페이지 데이터 품질 감사 — 2026-07-05

- DB: `/Applications/stock_dashboard/stock.db`
- HS DB: `/Applications/stock_dashboard/hs_trade_lab/data/hs_trade_lab.db`
- 생성: `2026-07-05T06:40:57`
- 요약: OK 27 / 수집필요 2 / 검토필요 2 / 누락 0

|페이지|데이터셋|테이블|상태|행수|기간|이슈|수집/보강|메모|
|---|---|---:|---|---:|---|---|---|---|
|메인 대시보드/차트|국내 OHLCV|`price_history`|ok|5886871|2010-01-04 ~ 2026-07-03|-|KIS collect_kis_ohlcv.py|-|
|메인 대시보드/종목검색|상장종목|`stock_universe`|ok|2693|2026-06-28 21:30:00 ~ 2026-06-28 21:53:17|-|KRX/Kiwoom stock info|-|
|시장지표|공공 일별 시세|`stock_price_daily`|ok_with_fallback|817017|20200102 ~ 20260701|covered_by:price_history+stock_universe<br>stock_price_daily의 market_cap 결측은 stock_universe로 보완 가능|public_data_collector.py / KIS fallback|페이지/전략의 주 시세 소스는 price_history이며 market_cap은 stock_universe fallback 가능|
|시장지표|투자자별 매매|`investor_trading_daily`|ok|4514952|2018-04-23 ~ 2026-07-03|-|public_data_collector.py / KIS|-|
|시장지표|Kiwoom 투자자 수급|`kiwoom_investor_daily`|ok|4514952|2018-04-23 ~ 2026-07-03|-|Kiwoom ka10059|-|
...
|시장지표|Kiwoom 외국인 지분|`kiwoom_foreign_flow`|ok|157390|20260312 ~ 20260703|-|Kiwoom ka10008|-|
|시장지표|대차잔고 종목|`short_sell_daily`|ok_with_fallback|3787128|20200102 ~ 20260702|covered_by:short_rank_daily.lnb_bal<br>종목별 API가 잔고금액을 제공하지 않는 구간은 대차순위 금액 필드로 보완|collect_short_5years.py / public_data_collector.py|-|
|시장지표|대차순위|`short_rank_daily`|ok|3303542|20210104 ~ 20260702|-|collect_short_5years.py|-|
...
|시장지표|월별 대차|`short_monthly_stat`|ok|235|20080131 ~ 20260701|-|collect_short_5years.py|-|
...
|재무/텐버거/DART Excel|연결 재무|`financial_data`|ok_with_fallback|191912|2015 ~ 2026|covered_by:canonical_financial_data<br>raw financial_data 중복 grain은 표준 테이블에서 해소|DART/FnGuide batch|-|
|재무/텐버거/DART Excel|표준 재무|`canonical_financial_data`|ok|90850|2015 ~ 2026|-|canonical rebuild|-|
|재무/텐버거/DART Excel|현금흐름|`cash_flow_data`|ok_with_fallback|128347|2016 ~ 2026|covered_by:canonical_cashflow_data<br>raw cash_flow_data 중복 grain은 표준 테이블에서 해소|DART cashflow batch|-|
...
|컨센서스/종목|컨센서스|`consensus_targets`|unstable_or_needs_review|11286|2024-05-08 ~ 2026-07-03|duplicate_grain:27|collect_consensus|report_idx가 없는 한경 리포트는 자연키로 중복 판정|
|텐버거|텐버거 결과|`tenbagger_results`|ok|1000|2026-06-06 10:20:15 ~ 2026-07-03 15:00:00|-|routes/tenbagger run|-|
