...
def main() -> None:
    ...
    if "000" in statuses:
        ...
        report["steps"]["order_backlog"] = collect_backlog_quarterly(year_from=y_to - 5, year_to=y_to, limit=None, report_type="CFS")
    ...
    out = f"/Applications/stock_dashboard/scratch/business_signal_collectors_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
