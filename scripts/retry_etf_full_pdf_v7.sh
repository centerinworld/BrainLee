#!/bin/zsh
set -u
ROOT="/Volumes/Realtek_NVME/stock_dashboard/runtime"; PYTHON="$ROOT/venv/bin/python"; LOG_DIR="$ROOT/ETF_check/logs"; LOCK_DIR="$ROOT/ETF_check/run/full_pdf.lock"; TARGET_DATE="$(date -v-1d '+%Y%m%d')"
